const questions = [
  ...
  {
    question: "where is zitouna moasque",
    answers: [
      { text: "Tunis", correct: true },
      { text: "Jandouba", correct: false },
      { text: "Tozer", correct: false },
      { text: "non above", correct: false },
    ],
  },
  {
...
startQuizz();
var popup = confirm("lets test your geography knowledge");
